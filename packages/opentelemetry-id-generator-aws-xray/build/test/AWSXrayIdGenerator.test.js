...
const idGenerator = new src_1.AWSXRayIdGenerator();
describe('AwsXRayTraceId', () => {
    let traceId1, traceId2;
    let prevTime, currTime, nextTime;
    beforeEach(() => {
    ...
    it('should not be all zero', () => {
        ...
        assert.notStrictEqual(traceIdTemp, api_1.INVALID_TRACEID);
    });
});
describe('AwsXRaySpanId', () => {
    ...
    it('should not be all zero', () => {
        ...
        assert.notStrictEqual(spanIdTemp, api_1.INVALID_SPANID);
    });
});
//# sourceMappingURL=AWSXrayIdGenerator.test.js.map